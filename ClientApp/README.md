# Front-end side of the aplication

This project is for a special course, was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).
